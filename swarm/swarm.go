...
import (
	...
	"github.com/ddmchain/go-ddmchain/contracts/chequebook"
	...
	"github.com/ddmchain/go-ddmchain/swarm/api"
	httpapi "github.com/ddmchain/go-ddmchain/swarm/api/http"
	"github.com/ddmchain/go-ddmchain/swarm/fuse"
	"github.com/ddmchain/go-ddmchain/swarm/network"
	"github.com/ddmchain/go-ddmchain/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *ddmclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
