...
// Package chequebook package wraps the 'chequebook' DDMchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in ddmx; (auto)cashing cheques in ddmx
// as well as (auto)depositing ddmx to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/ddmchain/go-ddmchain/contracts/chequebook/contract"
	"github.com/ddmchain/go-ddmchain/core/types"
	"github.com/ddmchain/go-ddmchain/crypto"
	"github.com/ddmchain/go-ddmchain/log"
	"github.com/ddmchain/go-ddmchain/swarm/services/swap/swap"
)
...
// * depositing ddmx to the chequebook
// * watching incoming ddmx
...
// Cash cashes the cheque by sending an DDMchain transaction.
