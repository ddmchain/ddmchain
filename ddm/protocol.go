...
var ProtocolName = "ddm"

// Supported versions of the ddm protocol (first is primary).
var ProtocolVersions = []uint{ddm63, ddm62}
...
// ddm protocol message codes
const (
	// Protocol messages belonging to ddm/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to ddm/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
