...
// Syncing provides information when this nodes starts synchronising with the DDMchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ddmchain.SyncProgress `json:"status"`
}
