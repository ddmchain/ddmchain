...
// PeerInfo represents a short summary of the DDMchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // DDMchain protocol version negotiated
...
// Handshake executes the ddm protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("ddm/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the DDMchain sub-protocol.
type peerSet struct {
