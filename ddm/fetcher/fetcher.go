...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (ddm/61) or header (ddm/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (ddm/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both ddm/61 and ddm/62)
}
