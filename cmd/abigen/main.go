...
import (
	...
	"github.com/ddmchain/go-ddmchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the DDMchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the DDMchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the DDMchain contract Solidity source to build and bind")
