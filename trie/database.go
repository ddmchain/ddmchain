...
type Database struct {
	diskdb ddmdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb ddmdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch ddmdb.Batch) error {
	// If the node does not exist, it's a previously committed node
