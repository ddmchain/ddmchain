...
// Package bind generates DDMchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ddmchain Wiki page:
// https://github.com/ddmchain/go-ddmchain/wiki/Native-DApps:-Go-bindings-to-DDMchain-contracts
package bind
