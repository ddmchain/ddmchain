...
// *
// Request: Ask device for DDMchain address corresponding to address_n path
// @next PassphraseRequest
// @next DDMchainAddress
// @next Failure
...
// *
// Response: Contains an DDMchain address derived from device private seed
// @prev DDMchainGetAddress
