...
// Package accounts implements high level DDMchain account management.
package accounts
...
// Account represents an DDMchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // DDMchain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain ddmchain.ChainStateReader)
