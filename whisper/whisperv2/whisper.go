...
import (
	...
	"github.com/ddmchain/go-ddmchain/crypto/ecies"
	"github.com/ddmchain/go-ddmchain/event/filter"
...
// Whisper represents a dark communication interface through the DDMchain
...
// New creates a Whisper client ready to communicate through the DDMchain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
