...
// Package core implements the DDMchain consensus protocol.
package core
...
type BlockChain struct {
	...
	db     ddmdb.Database // Low level persistent database to store final content in
...
// available in the database. It initialises the default DDMchain Validator and
// Processor.
