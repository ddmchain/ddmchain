...
type Context struct {
	...
	// sufficient ddmx to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers ddmx from one account to the other
...
// EVM is the DDMchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) ddmchain virtual machine
