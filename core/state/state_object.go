...
// stateObject represents an DDMchain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ddmchain address of the account
	data     Account
	db       *StateDB
...
// Account is the DDMchain consensus representation of accounts.
