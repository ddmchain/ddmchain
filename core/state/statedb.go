...
// Package state provides a caching layer atop the DDMchain state trie.
package state
...
// StateDBs within the ddmchain protocol are used to store anything
...
//
// Carrying over the balance ensures that DDMX doesn't disappear.
