...
// Trie is a DDMchain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb ddmdb.Putter) error
}
...
func NewDatabase(db ddmdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb ddmdb.Putter) error {
