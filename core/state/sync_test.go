...
// account array.
func checkStateAccounts(t *testing.T, db ddmdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ddmdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ddmdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ddmdb.Database), srcRoot)
