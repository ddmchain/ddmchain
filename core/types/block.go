...
// Package types contains data types related to DDMchain consensus.
package types
...
import (
	...
	"github.com/ddmchain/go-ddmchain/crypto/sha3"
...
// Header represents a block header in the DDMchain blockchain.
type Header struct {
...
// Block represents an entire block in the DDMchain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package ddm to track
...
// [deprecated by ddm/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for ddm protocol, etc.
...
// DecodeRLP decodes the DDMchain
...
// EncodeRLP serializes b into the DDMchain RLP block format.
