...
func SetupGenesisBlock(db ddmdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.AllDDMhashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllDDMhashProtocolChanges
	}
}

// ToBlock creates the genesis block and writes state of a genesis specification
// to the given database (or discards it if nil).
func (g *Genesis) ToBlock(db ddmdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db ddmdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
	...
	config := g.Config
	if config == nil {
		config = params.AllDDMhashProtocolChanges
	}
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db ddmdb.Database) *types.Block {
...
func GenesisBlockForTesting(db ddmdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the DDMchain main net genesis block.
...
// DeveloperGenesisBlock returns the 'gddm --dev' genesis block. Note, this must
// be seeded with the
