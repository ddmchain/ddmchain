...
// cacheSize returns the size of the ddmhash verification cache that belongs to a certain
// block number.
...
// datasetSize returns the size of the ddmhash mining dataset that belongs to a certain
// block number.
