...
// Package tests implements execution of DDMchain JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, ddmhash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/ddmchain/tests/wiki/Blockchain-Tests-II
