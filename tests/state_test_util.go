...
// See https://github.com/ddmchain/EIPs/issues/176 for the test format specification.
...
func MakePreState(db ddmdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ddmchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
