...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllDDMhashProtocolChanges, new: AllDDMhashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllDDMhashProtocolChanges, new: AllDDMhashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllDDMhashProtocolChanges,
