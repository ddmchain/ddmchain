...
var (
	...
	authorsFileHeader = "# This is the official list of go-ddmchain authors for copyright purposes.\n\n"
)

var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ddmchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-ddmchain library"
	}
	return "the go-ddmchain library"
}
