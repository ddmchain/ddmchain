...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gddm.ipc", false, filepath.Join(os.TempDir(), "gddm.ipc")},
		{"data", "gddm.ipc", false, "data/gddm.ipc"},
		{"data", "./gddm.ipc", false, "./gddm.ipc"},
		{"data", "/gddm.ipc", false, "/gddm.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gddm.ipc", true, `\\.\pipe\gddm.ipc`},
		{"data", "gddm.ipc", true, `\\.\pipe\gddm.ipc`},
		{"data", `\\.\pipe\gddm.ipc`, true, `\\.\pipe\gddm.ipc`},
	}
