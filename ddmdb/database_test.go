...
func newTestLDB() (*ddmdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ddmdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := ddmdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db ddmdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db ddmdb.Database, t *testing.T) {
	const n = 8
