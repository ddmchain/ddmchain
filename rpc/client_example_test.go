...
//
// ddm_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// ddm_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.DDMSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "ddm_getBlockByNumber", "latest"); err != nil {
