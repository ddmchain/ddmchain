...
// Contains all the wrappers from the go-ddmchain root package.
...
// the DDMchain network.
type SyncProgress struct {
	progress ddmchain.SyncProgress
}
