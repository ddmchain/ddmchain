...
// Reference: https://github.com/ddmchain/wiki/wiki/DDMhash-DAG
#define DAG_MUTABLE_NAME_MAX_SIZE (6 + 10 + 1 + 16 + 1)
/// Possible return values of @see ddmhash_io_prepare
enum ddmhash_io_rc {
	DDMHASH_IO_FAIL = 0,           ///< There has been an IO failure
	DDMHASH_IO_MEMO_SIZE_MISMATCH, ///< DAG with revision/hash match, but file size was wrong.
	DDMHASH_IO_MEMO_MISMATCH,      ///< The DAG file did not exist or there was revision/hash mismatch
	DDMHASH_IO_MEMO_MATCH,         ///< DAG file existed and revision/hash matched. No need to do anything
};
...
/**
 * Logs a critical error in important parts of ddmhash. Should mostly help
...
/**
 * Prepares io for ddmhash
 *
 * Create the DAG directory and the DAG file if they don't exist.
 *
 * @param[in] dirname        A null terminated c-string of the path of the ddmhash
 ...
 *                           https://github.com/ddmchain/wiki/wiki/DDMhash-DAG
 ...
 *                           already exists
 * @return                   For possible return values @see enum ddmhash_io_rc
 */
 ...
 *
 * The spec defining this directory is here: https://github.com/ddmchain/wiki/wiki/DDMhash-DAG
 *
